...
public class AbstractMenu {
    ...
    public AbstractMenu() {
        ...
        exploreButton.setOnMousePressed(e -> {
                AudioClip explore = new AudioClip(
                    "File:./src/main/java/view/music/explore.mp3");
                explore.play();
                GameController.getCivilization().explore();
                if (endTurn()) {
                    AudioClip win = new AudioClip(
                        "File:./src/main/java/view/music/Victory.mp3");
                    win.play();
        ...
        endTurnButton.setOnAction(event -> {
                AudioClip endTurn = new AudioClip(
                    "File:./src/main/java/view/music/end.mp3");
                endTurn.play();
                if (endTurn()) {
                    AudioClip win = new AudioClip(
                        "File:./src/main/java/view/music/Victory.mp3");
