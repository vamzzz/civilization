...
public class Model {
    ...
    public static void standings(int choice) {
        ...
        case 1:
            ...
            civs.sort((Civilization o1, Civilization o2) ->
                o1.getStrategy().getStrategyLevel()
                - o2.getStrategy().getStrategyLevel());
            Collections.reverse(civs);
            civs.forEach((civilization)->System.out.println(civilization
        ...
        case 2:
            ...
            civs.sort((Civilization o1, Civilization o2) ->
                o1.getHappiness() - o2.getHappiness());
            Collections.reverse(civs);
            civs.forEach((civilization)->System.out.println(civilization
        ...
        case 3:
            ...
            civs.sort((Civilization o1, Civilization o2) ->
                o1.getTechnology().getTechPoints()
                - o2.getTechnology().getTechPoints());
            Collections.reverse(civs);
            civs.forEach((civilization)->System.out.println(civilization
                + ": " + civilization.getTechnology().getTechPoints()));
            break;
        case 4:
            //Amount of resources
            System.out.println("People with the finest Resources:");
            civs.sort((Civilization o1, Civilization o2) ->o1.getResources()
                - o2.getResources());
            Collections.reverse(civs);
            civs.forEach((civilization)->System.out.println(civilization
        ...
        case 5:
            ...
            civs.sort((Civilization o1, Civilization o2) -> {
                    int c = o1.getNumSettlements();
                    int d = o2.getNumSettlements();
                    Integer p1 = new Integer(c);
                    Integer p2 = new Integer(d);
                    int a = o1.getStrategy().getStrategyLevel();
                    int b = o2.getStrategy().getStrategyLevel();
            ...
            Collections.reverse(civs);
            civs.forEach((civilization) ->System.out.println(civilization
                + ":  Settlements - " + civilization.getNumSettlements()
                + " Military level - "
                + civilization.getStrategy().getStrategyLevel()));
            break;
        default:
